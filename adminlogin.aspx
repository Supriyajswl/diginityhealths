...
<head runat="server">
  ...
  <link href="style/css/nucleo-svg.css" rel="stylesheet" />
  <!-- CSS Files -->
  <link id="pagestyle" href="style/css/soft-ui-dashboard.css?v=1.0.3" rel="stylesheet" />
</head>
<body>
...
<body class="">
            ...
            <div class="col-xl-4 col-lg-5 col-md-6 d-flex flex-column mx-auto">
              <div class="card card-plain mt-8">
                ...
                <div class="card-body">
                     ...
                     <label>Email</label>
                    <div class="mb-3">
    <asp:TextBox ID="TextBox1" runat="server" class="form-control" placeholder="Enter Your Email" aria-label="Email" aria-describedby="email-addon"></asp:TextBox>
                      </div>
                    <label>Password</label>
                    <div class="mb-3">
    <asp:TextBox ID="TextBox2" runat="server" class="form-control" placeholder="Enter your Password" aria-label="Enter Your Password" aria-describedby="password-addon"></asp:TextBox>
                      </div>
  ...
  <script src="style/js/soft-ui-dashboard.min.js?v=1.0.3"></script>
</body>
    </form>
</body>
</html>
